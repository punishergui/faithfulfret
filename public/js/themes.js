...
(function () {
  const themes = [
    ...
    },
    {
      ...
      metaColor: '#d8b98c',
      vars: { '--bg':'#15120f','--bg2':'#211a14','--panel':'rgba(39,32,22,0.86)','--panel2':'rgba(216,185,140,0.08)','--text':'#f4ead9','--text2':'#bfae8f','--line':'rgba(216,185,140,0.16)','--line2':'rgba(216,185,140,0.28)','--glow':'rgba(216,185,140,0.26)','--glow2':'rgba(216,185,140,0.14)','--accent':'#d8b98c','--accent2':'#efd2a3','--green':'#4dd886','--yellow':'#f0d96a','--red':'#ff6d73','--hero-bg-image':"url('/img/hero/djent.jpg')",'--hero-overlay':"linear-gradient(90deg, rgba(0,0,0,0.55), rgba(0,0,0,0.28))",'--hero-bg-opacity':'0.16','--hero-overlay-opacity':'1','--hero-bg-blend':'soft-light','--hero-bg-tint':'rgba(30, 22, 16, 0.44)' }
    },
    {
      id: 'spruce-top',
      name: 'SPRUCE TOP',
    ...
    },
    {
      ...
      metaColor: '#3dd6ff',
      vars: { '--bg':'#071017','--bg2':'#0f1f2e','--panel':'rgba(19,42,54,0.86)','--panel2':'rgba(61,214,255,0.08)','--text':'#e4f8ff','--text2':'#98b9c7','--line':'rgba(161,225,241,0.15)','--line2':'rgba(161,225,241,0.28)','--glow':'rgba(61,214,255,0.28)','--glow2':'rgba(61,214,255,0.15)','--accent':'#3dd6ff','--accent2':'#86ebff','--green':'#4ce3ae','--yellow':'#f0dd74','--red':'#ff7272','--hero-bg-image':"url('/img/hero/djent.jpg')",'--hero-overlay':"linear-gradient(90deg, rgba(0,0,0,0.55), rgba(0,0,0,0.28))",'--hero-bg-opacity':'0.12','--hero-overlay-opacity':'1','--hero-bg-blend':'overlay','--hero-bg-tint':'rgba(5, 18, 26, 0.5)' }
    },
    {
      id: 'radioactive-gain',
    ...
    },
    {
      ...
      metaColor: '#cfd7e3',
      vars: { '--bg':'#101112','--bg2':'#1b1f25','--panel':'rgba(42,48,56,0.86)','--panel2':'rgba(207,215,227,0.06)','--text':'#f2f5fa','--text2':'#b4bbc7','--line':'rgba(196,203,214,0.15)','--line2':'rgba(196,203,214,0.26)','--glow':'rgba(207,215,227,0.22)','--glow2':'rgba(207,215,227,0.12)','--accent':'#cfd7e3','--accent2':'#edf2f9','--green':'#64d28e','--yellow':'#e8d06c','--red':'#ff6f79','--hero-bg-image':"url('/img/hero/djent.jpg')",'--hero-overlay':"linear-gradient(90deg, rgba(0,0,0,0.55), rgba(0,0,0,0.28))",'--hero-bg-opacity':'0.11','--hero-overlay-opacity':'1','--hero-bg-blend':'soft-light','--hero-bg-tint':'rgba(20, 22, 26, 0.48)' }
    },
    {
      id: 'tape-saturation',
