...
After deploy, verify adding nested playlist/video items from `#/training/playlists/:id` succeeds without popup errors, and add/move/remove controls continue working.
